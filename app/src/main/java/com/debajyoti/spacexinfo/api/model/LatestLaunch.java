...
import static com.debajyoti.spacexinfo.utils.AppConstants.LATEST_LAUNCH_TABLE;
import static com.debajyoti.spacexinfo.utils.AppConstants.PAST_LAUNCHES_TABLE;

@Entity(tableName = LATEST_LAUNCH_TABLE)
public class LatestLaunch {
    @PrimaryKey
    ...
    public LatestLaunch(int flightNumber,
                        String missionName,
                        String launchYear,
                        long launchDateUnix,
